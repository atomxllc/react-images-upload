  ...
  render() {
    return (
      <div className="page">
        ...
        <p>
          Simple component for upload and validate (client side) images with
          preview built with React.js.
        </p>
          ...
          <tbody className="table-hover">
            ...
            <tr>
              ...
              <td className="text-left">
                Inline styles for file upload container.
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td className="text-left">
                The text that display in the button.
              </td>
            </tr>
            <tr>
              ...
              <td className="text-left">
                The value of the button's type attribute
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td className="text-left">
                Label for file extension error message.
              </td>
            </tr>
            <tr>
